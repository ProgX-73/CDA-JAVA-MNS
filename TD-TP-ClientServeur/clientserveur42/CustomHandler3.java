...
public class CustomHandler3 implements HttpHandler {
	...
	//Création d'un fileReader pour lire le fichier
				...
				//Ici ImageIO est utilisé comme un utilitaire
				//pour envoyer l'image dans le flux en entier.
				//Sinon comme pour le fichier texte
				//On aurait du lire d'un côté le flux img et écrire en même temps dans le flux sortant
